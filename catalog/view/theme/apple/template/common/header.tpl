...
<head>
  ...
  <?php } ?>
  <script src="catalog/view/theme/apple/libs/equalheight/dist/jquery.equalheight.js"></script>
...
<body class="<?php echo $class; ?>">
  ...
  <nav id="top" class="topMenu">
    <div class="container">
      <div class="row">
        <div class="col-sm-9">

          <nav id="menu" class="navbar">
            <div class="navbar-header"><span class="toggle-top-text hidden-sm hidden-md hidden-lg">
